...
class socialMedia:
    ...
    def __init__(self, database, socialMediaType):
        ...
        self.__crimeScore = {"scam": 0, "drug": 0,
                             "violence": 0, "sexOffence": 0}
    ...
    def __generateCrimeScore(self):
        ...
        drug = {"drug", "drugs", "smuggle", "cannibis", "marijuana",
                ...
                "trafficking"}
        violence = {"abuse", "abused", "abusing", "attack", "attacked", "attacking", "attacker", "assault", "assaulted", "assaulting", "stabed",
